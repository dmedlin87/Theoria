...
THEO_SEARCH_API_KEY=Bearer local-dev-key
```
...
export THEO_SEARCH_API_KEY="Bearer local-dev-key"
npm run dev
```
...
```bash
# .env
THEO_API_KEYS='["local-dev-key", "another-key"]'
```
