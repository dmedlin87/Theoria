...
- **Relevant files:**
  - `theo/infrastructure/api/app/infra/ingestion_service.py` imports the CLI ingest entry point. 【F:theo/infrastructure/api/app/infra/ingestion_service.py†L1-L60】
  ...
  - `theo/infrastructure/api/app/workers/tasks.py` imports `build_sermon_deliverable` from the RAG package, closing the circular chain. 【F:theo/infrastructure/api/app/workers/tasks.py†L1-L28】
