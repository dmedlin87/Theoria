...
This inventory lists every Markdown/PDF document tracked in the repository as of this audit run. Recommendations are heuristic-based starting points—follow up with subject matter experts for final decisions.
...
| `ANIMATION_ENHANCEMENTS_COMPLETE.md` | # 🎉 Animation Enhancements Complete | 2025-10-13 | Archive or consolidate once knowledge is captured. |
...
| `DISCOVERY_IMPLEMENTATION_SUMMARY.md` | # 🔍 Discovery Feature - Implementation Summary | 2025-10-15 | Archive or consolidate once knowledge is captured. |
...
| `START_HERE.md` | # 🚀 Start Theoria - The Smart Way | 2025-10-12 | Keep actively maintained; ensure contents stay current. |
...
| `UX_IMPROVEMENTS_COMPLETE.md` | # ✅ Theoria UX Improvements - Implementation Complete | 2025-10-15 | Archive or consolidate once knowledge is captured. |
...
| Path | First heading / line | Last commit | Suggested action |
| --- | --- | --- | --- |
| `dashboard/coverage-dashboard.md` | # 📊 Test Coverage Dashboard | 2025-10-15 | Needs manual triage for relevance. |
...
| `docs/DISCOVERY_FEATURE.md` | # 🔍 Discovery Feature - Implementation Guide | 2025-10-15 | Needs manual triage for relevance. |
| `docs/DISCOVERY_QUICK_START.md` | # 🔍 Discovery Feature - Quick Start Guide | 2025-10-15 | Keep actively maintained; ensure contents stay current. |
| `docs/FUTURE_FEATURES_ROADMAP.md` | # 🚀 Theoria - Future Features Roadmap | 2025-10-15 | Keep actively maintained; ensure contents stay current. |
...
| `docs/case builder v2.md` | # Case Builder Buddy (Convergence Triggers) – Phased Implementation Plan | 2025-10-10 | Needs manual triage for relevance. |
| `docs/case-builder-v1.md` | # Case Builder v1 Plan | 2025-10-10 | Needs manual triage for relevance. |
| `docs/case_builder_buddy_summary.md` | # Case Builder Buddy – Convergence Triggers Blueprint Summary | 2025-10-10 | Archive or consolidate once knowledge is captured. |
...
| `theo/services/web/UI_FIXES_SUMMARY_PHASE_1_2.md` | # UI Glitch Fixes - Phase 1 & 2 Complete ✅ | 2025-10-14 | Archive or consolidate once knowledge is captured. |
