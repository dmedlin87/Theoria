...
- Escalate any performance anomalies using the [Performance Discrepancy Runbook](../runbooks/performance_discrepancy_runbook.md) to ensure DevOps is looped in for load testing and mitigation decisions.
