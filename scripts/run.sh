...
setup_python_env() {
    ...
    if [ -f "$PROJECT_ROOT/pyproject.toml" ]; then
        ...
        pip install -q ".[api]" -c "$PROJECT_ROOT/constraints/guardrails.txt" -c "$PROJECT_ROOT/constraints/prod.txt"
        pip install -q ".[ml]" -c "$PROJECT_ROOT/constraints/guardrails.txt" -c "$PROJECT_ROOT/constraints/prod.txt"
        pip install -q ".[dev]" -c "$PROJECT_ROOT/constraints/guardrails.txt" -c "$PROJECT_ROOT/constraints/dev.txt"
