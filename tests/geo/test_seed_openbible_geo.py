...
from theo.infrastructure.geo import seed_openbible_geo as seed_openbible_geo_public

seed_openbible_geo_module = import_module("theo.infrastructure.geo.seed_openbible_geo")
from theo.infrastructure.geo.seed_openbible_geo import (
    _detect_commit_sha,
