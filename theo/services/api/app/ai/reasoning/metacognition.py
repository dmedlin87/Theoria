...
# Increase the penalty so one severe fallacy drops the score well below 70 to
# ensure egregious reasoning is never misclassified as adequate.
HIGH_FALLACY_PENALTY = 30
