...
# Common given names that often appear in bibliographies in uppercase form.
_COMMON_UPPERCASE_GIVEN_NAMES = {
    "aaron",
    "abigail",
    "adam",
    "adrian",
...
# Common surnames for filtering out likely personal-name combinations.
_COMMON_UPPERCASE_SURNAMES = {
    "adams",
    "aguilar",
    "alexander",
    "allen",
