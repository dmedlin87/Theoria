"""High level orchestration for the ingestion pipeline."""
...
def _prepare_for_source(
    ...
    span,
) -> tuple[ParserResult, dict[str, Any], str, str, str]:
    ...
    return parser_result, frontmatter, text_content, sha256, source_type
...
def run_pipeline_for_file(
    ...
    *,
    ...
    with instrument_workflow(
        ...
        frontmatter = merge_metadata({}, load_frontmatter(frontmatter))
        (
            parser_result,
            merged_frontmatter,
            text_content,
            ...
            settings, path, frontmatter, span
        )
