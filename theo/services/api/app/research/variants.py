...
def variants_apparatus(
    ...
    *,
    ...
    The starter implementation performs a simple lookup in bundled
    JSON datasets keyed by OSIS identifiers. When a range is supplied the
    apparatus notes for each contained verse are concatenated in verse order.
    """
