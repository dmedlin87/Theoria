"""Workflow routes producing AI-assisted deliverables."""
...
from .common import BAD_REQUEST_RESPONSE
...
def multimedia_digest(
    ...
    try:
        with trail_service.start_trail(
            ...
            recorder.finalize(
                final_md=response.answer.summary if response.answer else None,
