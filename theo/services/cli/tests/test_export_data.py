...
from theo.services.api.app.models.export import ExportManifest
...
def export_module(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> ModuleType:
    ...
    monkeypatch.setattr(
        "theo.services.bootstrap.resolve_application",
    ...
    install_stub(
        "theo.services.api.app.export.citations",
        {
    ...
    install_stub(
        "theo.services.api.app.export.formatters",
        {
    ...
    install_stub(
        "theo.services.api.app.models.search",
        {
    ...
    install_stub(
        "theo.services.api.app.retriever.export",
        {
    ...
    install_stub(
        "theo.services.api.app.retriever.verses",
        {"get_mentions_for_osis": lambda *a, **k: []},
    )
    install_stub(
        "theo.services.api.app.models.verses",
        {
