...
export async function POST(
  ...
  const target = new URL(`/discoveries/${encodeURIComponent(id)}/view`, `${baseUrl}/api`);
  ...
  try {
    ...
    return createProxyErrorResponse({
      error,
      logContext: "Failed to mark discovery as viewed",
      message: "Unable to mark discovery as viewed. Please try again shortly.",
    });
  }
}
